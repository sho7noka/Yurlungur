...
from yurlungur.core.command import cmd, file, node, attr
...
if env.Maya() or env.Houdini() or env.Substance() or env.Nuke() or env.Davinci() or env.Rumba() or env.UE4() or env.C4D():
